      ...
      if (sector_ofs == 0 && chunk_size == BLOCK_SECTOR_SIZE)
        {
          ...
          buffer_cache_read_sector(fs_device, sector_idx, buffer + bytes_read);
      ...
      else 
        {
          ...
          buffer_cache_read_sector(fs_device, sector_idx, bounce);
      ...
      if (sector_ofs == 0 && chunk_size == BLOCK_SECTOR_SIZE)
        {
          ...
          buffer_cache_write_sector(fs_device, sector_idx, buffer + bytes_written);
      ...
      else 
        {
          ...
          buffer_cache_write_sector(fs_device, sector_idx, bounce);
